...
IncludeProjectFromDirectory("Assets/TerrainAsset",         "TerrainAsset")
IncludeProjectFromDirectory("Assets/TerrainAssetTests",    "TerrainAssetTests")
IncludeProjectFromDirectory("Assets/CloudscapeAsset",      "CloudscapeAsset")
