...
void ExecuteDeferredShading(rg::RenderGraphBuilder& graphBuilder, const DeferredShadingParams& shadingParams)
{
	...
	viewContext.luminance = graphBuilder.CreateTextureView(RG_DEBUG_NAME("View Luminance Texture"), rg::TextureDef(viewSpec.GetRenderingRes(), SceneRendererStatics::hdrFormat));
