...
void RTReflectionsStatsView::DrawUI()
{
	...
	const auto drawRaysNumber = [](const char* label, Uint32 raysNum, Real32 raysPercentage)
	{
...

	{
		...
		drawRaysNumber("First Pass Rays Info", m_lastFirstPassRaysNum, m_lastFirstPassRaysPercentage);
		...
		drawRaysNumber("Second Pass Rays Info", m_lastSecondPassRaysNum, m_lastSecondPassRaysPercentage);
	}
}
