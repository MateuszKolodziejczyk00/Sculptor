...
{
	return std::make_unique<RawFunctionBinding<TFuncType, TDelegateSignature, std::remove_reference_t<TPayload>...>>(function, std::forward<TPayload>(payload)...);
}
...
{
	return std::make_unique<RawMemberFunctionBinding<TObjectType, TFuncType, TDelegateSignature, std::remove_reference_t<TPayload>...>>(object, function, std::forward<TPayload>(payload)...);
}
...
{
	return std::make_unique<SharedMemberFunctionBinding<TObjectType, TFuncType, TDelegateSignature, std::remove_reference_t<TPayload>...>>(std::move(object), function, std::forward<TPayload>(payload)...);
}
...
{
	return std::make_unique<WeakMemberFunctionBinding<TObjectType, TFuncType, TDelegateSignature, std::remove_reference_t<TPayload>...>>(object, function, std::forward<TPayload>(payload)...);
}
...
{
	return std::make_unique<LambdaBinding<TLambda, TDelegateSignature, std::remove_reference_t<TPayload>...>>(std::forward<TLambda>(callable), std::forward<TPayload>(payload)...);
}
