...
void StaticMeshesRenderSystem::RenderPerFrame(rg::RenderGraphBuilder& graphBuilder, const SceneRendererInterface& rendererInterface, const RenderScene& renderScene, const lib::DynamicPushArray<ViewRenderingSpec*>& viewSpecs, const SceneRendererSettings& settings)
{
...

	{
		...
		m_shadowMapRenderer.RenderPerFrame(graphBuilder, rendererInterface, renderScene, shadowMapViewSpecs);
	}
...
void StaticMeshesRenderSystem::FinishRenderingFrame(rg::RenderGraphBuilder& graphBuilder, const SceneRendererInterface& rendererInterface, const RenderScene& renderScene)
{
	Super::FinishRenderingFrame(graphBuilder, rendererInterface, renderScene);
...
void StaticMeshesRenderSystem::RenderPerView(rg::RenderGraphBuilder& graphBuilder, const RenderScene& renderScene, ViewRenderingSpec& viewSpec)
{
	...
	{
		viewSpec.GetRenderViewEntry(ERenderViewEntry::RenderToShadowMap).AddRawMember(&m_shadowMapRenderer, &StaticMeshShadowMapRenderer::RenderToShadowMap);
	}
}
