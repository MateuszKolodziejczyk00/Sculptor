...
void StaticMeshShadowMapRenderer::RenderPerFrame(rg::RenderGraphBuilder& graphBuilder, const SceneRendererInterface& rendererInterface, const RenderScene& renderScene, const lib::DynamicArray<ViewRenderingSpec*>& viewSpecs)
{
	...
	if (const ShadowMapsRenderSystem* shadowMapsRenderSystem = rendererInterface.GetRenderSystem<ShadowMapsRenderSystem>())
	{
	...
	{
		const rg::BindDescriptorSetsScope rendererDSScope(graphBuilder, rg::BindDescriptorSets(viewSpec->GetRenderViewDS()));
...
void StaticMeshShadowMapRenderer::RenderToShadowMap(rg::RenderGraphBuilder& graphBuilder, SceneRendererInterface& rendererInterface, const RenderScene& renderScene, ViewRenderingSpec& viewSpec, const RenderViewEntryContext& context)
{
	SPT_PROFILER_FUNCTION();
