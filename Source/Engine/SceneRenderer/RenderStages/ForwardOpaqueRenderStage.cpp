...
void ForwardOpaqueRenderStage::OnRender(rg::RenderGraphBuilder& graphBuilder, SceneRendererInterface& rendererInterface, const RenderScene& renderScene, ViewRenderingSpec& viewSpec, const RenderStageExecutionContext& stageContext)
{
	...
	const math::Vector2u renderingArea = viewSpec.GetRenderingRes();
	...
	graphBuilder.RenderPass(RG_DEBUG_NAME("Forward Opaque Render Pass"),
							renderPassDef,
							rg::BindDescriptorSets(shadingParams.shadingInputDS),
