...
#include "Utils/Geometry/GeometryVisPassRenderer.h"
...
private:
	...
	void ExecuteVisbilityBufferRendering(rg::RenderGraphBuilder& graphBuilder, const SceneRendererInterface& rendererInterface, const RenderScene& renderScene, ViewRenderingSpec& viewSpec, const RenderStageExecutionContext& stageContext);
