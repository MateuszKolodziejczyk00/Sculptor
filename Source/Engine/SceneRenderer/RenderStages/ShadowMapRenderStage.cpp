...
void ShadowMapRenderStage::OnRender(rg::RenderGraphBuilder& graphBuilder, SceneRendererInterface& rendererInterface, const RenderScene& renderScene, ViewRenderingSpec& viewSpec, const RenderStageExecutionContext& stageContext)
{
	SPT_PROFILER_FUNCTION();

	const RenderView& renderView = viewSpec.GetRenderView();

	const ShadowMapsRenderSystem& shadowMapRenderSystem = rendererInterface.GetRenderSystemChecked<ShadowMapsRenderSystem>();
	...
	case EShadowMappingTechnique::CSM:
		RenderCSM(graphBuilder, rendererInterface, renderScene, viewSpec, stageContext, shadowMap);
		break;

	case EShadowMappingTechnique::DPCF:
		RenderDPCF(graphBuilder, rendererInterface, renderScene, viewSpec, stageContext, shadowMap);
		break;
	
	case EShadowMappingTechnique::VSM:
		RenderVSM(graphBuilder, rendererInterface, renderScene, viewSpec, stageContext, shadowMap);
		break;
...
void ShadowMapRenderStage::RenderDepth(rg::RenderGraphBuilder& graphBuilder, SceneRendererInterface& rendererInterface, const RenderScene& renderScene, ViewRenderingSpec& viewSpec, const RenderStageExecutionContext& stageContext, const rg::RGTextureViewHandle depthRenderTargetView)
{
	SPT_PROFILER_FUNCTION();
	...
	viewSpec.GetRenderViewEntry(ERenderViewEntry::RenderToShadowMap).Broadcast(graphBuilder, rendererInterface, renderScene, viewSpec, RenderViewEntryContext{});
}

void ShadowMapRenderStage::RenderCSM(rg::RenderGraphBuilder& graphBuilder, SceneRendererInterface& rendererInterface, const RenderScene& renderScene, ViewRenderingSpec& viewSpec, const RenderStageExecutionContext& stageContext, const rg::RGTextureHandle shadowMap)
{
	const math::Vector2u res = viewSpec.GetRenderingRes();
...
void ShadowMapRenderStage::RenderDPCF(rg::RenderGraphBuilder& graphBuilder, SceneRendererInterface& rendererInterface, const RenderScene& renderScene, ViewRenderingSpec& viewSpec, const RenderStageExecutionContext& stageContext, const rg::RGTextureHandle shadowMap)
{
	...
	RenderDepth(graphBuilder, rendererInterface, renderScene, viewSpec, stageContext, shadowMapTextureView);
}

void ShadowMapRenderStage::RenderMSM(rg::RenderGraphBuilder& graphBuilder, SceneRendererInterface& rendererInterface, const RenderScene& renderScene, ViewRenderingSpec& viewSpec, const RenderStageExecutionContext& stageContext, const rg::RGTextureHandle shadowMap)
{
	SPT_PROFILER_FUNCTION();
	...
	const math::Vector3u horizontalBlurWorkCount = math::Utils::DivideCeil(viewSpec.GetRenderingRes3D(), math::Vector3u(256, 1, 1));
	...
	const math::Vector3u verticalBlurWorkCount = math::Utils::DivideCeil(viewSpec.GetRenderingRes3D(), math::Vector3u(1, 256, 1));
...
void ShadowMapRenderStage::RenderVSM(rg::RenderGraphBuilder& graphBuilder, SceneRendererInterface& rendererInterface, const RenderScene& renderScene, ViewRenderingSpec& viewSpec, const RenderStageExecutionContext& stageContext, const rg::RGTextureHandle shadowMap)
{
	SPT_PROFILER_FUNCTION();
	...
	RenderDepth(graphBuilder, rendererInterface, renderScene, viewSpec, stageContext, depthRenderTarget);
