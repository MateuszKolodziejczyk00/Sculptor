...
{
	const SceneRendererInterface& rendererInterface;
...
void DeferredShadingRenderStage::OnRender(rg::RenderGraphBuilder& graphBuilder, SceneRendererInterface& rendererInterface, const RenderScene& renderScene, ViewRenderingSpec& viewSpec, const RenderStageExecutionContext& stageContext)
{
	SPT_PROFILER_FUNCTION();

	viewSpec.GetRenderViewEntry(ERenderViewEntry::BuildLightsTiles).Broadcast(graphBuilder, rendererInterface, renderScene, viewSpec, RenderViewEntryContext{});
	...
	{
		const deferred_shading::DeferredShadingParams params{ rendererInterface, viewSpec, renderScene, luminance };
	...
	viewSpec.GetRenderViewEntry(ERenderViewEntry::RenderParticipatingMedia).Broadcast(graphBuilder, rendererInterface, renderScene, viewSpec, RenderViewEntryContext{});
}
